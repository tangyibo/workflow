...
@Component
public class ServiceHandler4 implements JavaDelegate {

	private static final Logger logger = LoggerFactory.getLogger(ServiceHandler4.class);
	...
	public void execute(DelegateExecution execution) {
		logger.info("+++++++++++++++++++++++++++++++++");
		logger.info("ServiceHandler4 已经执行！");
