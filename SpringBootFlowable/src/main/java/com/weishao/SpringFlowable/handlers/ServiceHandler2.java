...
@Component
public class ServiceHandler2 implements JavaDelegate {

	private static final Logger logger = LoggerFactory.getLogger(ServiceHandler2.class);
	...
	public void execute(DelegateExecution execution) {
		logger.info("+++++++++++++++++++++++++++++++++");
		logger.info("ServiceHandler2 已经执行！");
