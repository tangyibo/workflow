...
@Component
public class ServiceHandler3 implements JavaDelegate {

	private static final Logger logger = LoggerFactory.getLogger(ServiceHandler3.class);
	...
	public void execute(DelegateExecution execution) {
		logger.info("+++++++++++++++++++++++++++++++++");
		logger.info("ServiceHandler3 已经执行！");
